...
class MinionCodeAgent(CodeAgent):
    ...
    DEFAULT_SYSTEM_PROMPT = (
        ...
        "- Use `user_input` only when you need structured clarifications, especially multiple fields or explicit choices collected together.\n"
        "- For simple clarifications or conversational follow-ups, ask directly in assistant text instead of calling `user_input`.\n"
