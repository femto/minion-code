...
async def test_clear_command():
    ...
    console.print(f"History after force clear: {len(agent._conversation_history)} messages\n")
    ...
    console.print("[bold yellow]Test 2: Clear without force (with confirmation prompt)[/bold yellow]")
    console.print("[dim]Note: This will wait for your input. Type 'y' to confirm or 'n' to cancel.[/dim]\n")
    await clear_command.execute("")
    console.print(f"History after interactive clear: {len(agent._conversation_history)} messages\n")
